...
include "header.php";
?>
<a href="instrutor.php" class="btn btn-success btn-md"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span> Voltar</a>
<?php
if(isset($_POST['bts'])):
  if($_POST['nm']!=null ){
    // INSERT INTO "nome da tabela" e os registro que deseja salvar no banco, "?" responsavel por cada registro que o usuario digitou
     $stmt = $mysqli->prepare("INSERT INTO instrutor (NomeInstrutor) VALUES (?)");
...
<div class="alert alert-success alert-dismissible" role="alert">
  ...
  <strong>Success!</strong> Indicates a successful or positive action. <a href="instrutor.php">Home</a>.
</div>
<?php
     else:
?>
