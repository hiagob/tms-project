...
include "header.php";
?>
<a href="instrumento.php" class="btn btn-success btn-md"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span> Voltar</a>
<?php
if(isset($_POST['bts'])):
  if($_POST['nm']!=null ){
    // INSERT INTO "nome da tabela" e os registro que deseja salvar no banco, "?" responsavel por cada registro que o usuario digitou
     $stmt = $mysqli->prepare("INSERT INTO instrumento (NomeInstrumento) VALUES (?)");
...
<div class="alert alert-success alert-dismissible" role="alert">
  ...
  <strong>Success!</strong> Indicates a successful or positive action. <a href="instrumento.php">Home</a>.
</div>
<?php
     else:
?>
