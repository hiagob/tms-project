...
if(isset($_GET['u'])):
     if(isset($_POST['bts'])):
          ...
          $stmt = $mysqli->prepare("UPDATE marca SET NomeMarca=? WHERE IdMarca=?");
     ...
     $res = $mysqli->query("SELECT * FROM marca WHERE IdMarca=".$_GET['u']);
     $row = $res->fetch_assoc();
?>
  ...
  <form role="form" method="post">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="nm" id="nm" value="<?php echo $row['NomeMarca'] ?>">
    </div>
